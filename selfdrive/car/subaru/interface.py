...
class CarInterface(CarInterfaceBase):
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), car_fw=None):
    ...
    if candidate == CAR.IMPREZA_2020: # From https://github.com/scullionw/openpilot/blob/master-ci-crosstrek-2020-sng/selfdrive/car/subaru/interface.py#L44
